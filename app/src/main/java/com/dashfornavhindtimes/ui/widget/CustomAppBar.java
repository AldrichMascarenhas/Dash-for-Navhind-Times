package com.dashfornavhindtimes.ui.widget;
...
public class CustomAppBar extends AppBarLayout {
    ...
    @Nullable
    @BindView(com.dashfornavhindtimes.R.id.view_main_toolbar__toolbar_general)
    Toolbar toolbarGeneral;

    @BindView(com.dashfornavhindtimes.R.id.view_main_toolbar__toolbar_specific) Toolbar toolbarSpecific;


    @Nullable
    @BindView(com.dashfornavhindtimes.R.id.view_main_toolbar__space_toolbar)
    View space;
    ...
    private void init() {
        LayoutInflater.from(getContext()).inflate(com.dashfornavhindtimes.R.layout.view_main_toolbar, this, true);
        ButterKnife.bind(this);

        if (toolbarGeneral != null) {
            toolbarGeneral.setNavigationIcon(R.drawable.ic_action_menu);
        } else {
            toolbarSpecific.setNavigationIcon(R.drawable.ic_action_menu);
        }
    }
