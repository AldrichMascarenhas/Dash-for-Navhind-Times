...
public class BoundedCardView extends CardView {
    ...
    public BoundedCardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, com.dashfornavhindtimes.R.styleable.BoundedView);
        boundedWidth = a.getDimensionPixelSize(com.dashfornavhindtimes.R.styleable.BoundedView_bounded_width, 0);
        boundedHeight = a.getDimensionPixelSize(com.dashfornavhindtimes.R.styleable.BoundedView_bounded_height, 0);
        a.recycle();
    }
