...
import com.dashfornavhindtimes.ui.util.ViewUtils;
...
public class ContainersLayout extends FrameLayout {
    ...
    @Nullable
    @BindView(com.dashfornavhindtimes.R.id.activity_main__space_master)
    View spaceMaster;
    @Nullable
    @BindView(com.dashfornavhindtimes.R.id.activity_main__space_details)
    View spaceDetails;

    @BindView(com.dashfornavhindtimes.R.id.activity_main__frame_master)
    ViewGroup frameMaster;
    @BindView(com.dashfornavhindtimes.R.id.activity_main__frame_details)
    ...
    private void init() {
        LayoutInflater.from(getContext()).inflate(com.dashfornavhindtimes.R.layout.view_main_containers, this, true);
